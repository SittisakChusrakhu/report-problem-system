import { AddCircleOutline, BarChart, Description, Home, Logout, Menu, NotificationsActive, School } from "@mui/icons-material";
import {
    Toolbar,
    ListItem,
    ListItemButton,
...
// ---- Design tokens (matches NavbarStu / NavbarLect) ----
const colors = {
    tealDeep: "#0F2E2A",
    tealBase: "#1F4F49",
    gold: "#C9A227",
                ...
                >
                    <Toolbar>
                        ...
                        <Tooltip title="การแจ้งเตือน">
                            <IconButton sx={{ color: colors.inkMuted }}>
                                <NotificationsActive />
                            </IconButton>
                        </Tooltip>
