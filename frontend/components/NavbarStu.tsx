...
const navItems = [
    { href: "/stu_home", label: "หน้าหลัก", icon: <Home /> },
    { href: "/stu_report", label: "แจ้งปัญหา", icon: <AddAlert /> },
    { href: "/stu_listreport", label: "รายงานปัญหาของคุณ", icon: <Description /> },
    { href: "/stu_edit", label: "แก้ไขข้อมูลส่วนตัว", icon: <Create /> },
];
